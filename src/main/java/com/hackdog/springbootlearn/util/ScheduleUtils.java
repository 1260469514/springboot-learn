...
public class ScheduleUtils {
    ...
    private static Scheduler scheduler = (Scheduler) SpringContextsUtil.getBean("scheduler");
     ...
     */
    public static CronTrigger getCronTrigger(Long jobId) throws QuartzException {
        try {
            return (CronTrigger) scheduler.getTrigger(getTriggerKey(jobId));
        } catch (SchedulerException e) {
            throw new QuartzException("获取定时任务CronTrigger出现异常");
        }
    }
     ...
     * @throws QuartzException
     */
    public static void createScheduleJob(QuartzJob scheduleJob) throws QuartzException {
        try {
            //构建job信息
     ...
     * @throws QuartzException
     */
    public static void updateScheduleJob(QuartzJob scheduleJob) throws QuartzException {
        try {
            ...
            throw new QuartzException("更新定时任务失败");
        }
    }
     ...
     * @throws QuartzException
     */
    public static void run(QuartzJob scheduleJob) throws QuartzException {
        try {
            //参数
     ...
     * @throws QuartzException
     */
    public static void pauseJob(Long jobId) throws QuartzException {
        try {
            scheduler.pauseJob(getJobKey(jobId));
        } catch (SchedulerException e) {
            throw new QuartzException("暂停定时任务失败");
        }
    }
     ...
     * @throws QuartzException
     */
    public static void resumeJob(Long jobId) throws QuartzException {
        try {
            scheduler.resumeJob(getJobKey(jobId));
        } catch (SchedulerException e) {
            throw new QuartzException("恢复定时任务失败");
        }
    }
     ...
     * @throws QuartzException
     */
    public static void deleteScheduleJob(Long jobId) throws QuartzException {
        try {
            scheduler.deleteJob(getJobKey(jobId));
        } catch (SchedulerException e) {
            throw new QuartzException("删除定时任务失败");
        }
    }
}
